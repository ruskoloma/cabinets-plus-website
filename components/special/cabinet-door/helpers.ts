...
const TYPENAME_TO_TEMPLATE: Record<string, string> = {
  ...
  TemplatesCabinetBlocksCabinetProductInfo: "cabinetProductInfo",
  TemplatesCabinetBlocksProjectsUsingThisProduct: "projectsUsingThisProduct",
  TemplatesCabinetBlocksRelatedProducts: "relatedProducts",
