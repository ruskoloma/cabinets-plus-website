import { buildCountertopProjectMatches } from "@/components/special/catalog-product/project-matching";
...
import type { CabinetPageTextConfig } from "@/components/special/cabinet-door/types";
import type {
  CountertopData,
  CountertopListItem,
  CountertopMediaItem,
...
const TYPENAME_TO_TEMPLATE: Record<string, string> = {
  ...
  TemplatesCountertopBlocksCountertopProductInfo: "countertopProductInfo",
  TemplatesCountertopBlocksProjectsUsingThisProduct: "projectsUsingThisProduct",
  TemplatesCountertopBlocksRelatedProducts: "relatedProducts",
