...
import { useSharedSectionBlock } from "@/components/shared/use-shared-sections";
...
export default function ProjectDetailPage({
  ...
  const resolvedContactBlock = contactBlock || sharedContactBlock;
  ...
  return (
    <div className="bg-white">
      ...
      {resolvedContactBlock ? <ContactUsSection block={resolvedContactBlock} /> : null}
