import { buildFlooringProjectMatches } from "@/components/special/catalog-product/project-matching";
...
const TYPENAME_TO_TEMPLATE: Record<string, string> = {
  ...
  TemplatesFlooringBlocksFlooringProductInfo: "flooringProductInfo",
  TemplatesFlooringBlocksProjectsUsingThisProduct: "projectsUsingThisProduct",
  TemplatesFlooringBlocksRelatedProducts: "relatedProducts",
