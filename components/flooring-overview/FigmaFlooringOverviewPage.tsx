...
import { FlooringPartnersSection } from "@/components/catalog-overview/OurPartnersSection";
...
const FALLBACK_MATERIAL_IMAGES = [
  "https://cabinetsplus4630.s3.us-west-2.amazonaws.com/library/home/product-flooring.jpg",
...
export default function FigmaFlooringOverviewPage({ page }: Props) {
  ...
  const dedicatedPartners = getBlock(parsedBlocks, "flooringPartnersSection");
  ...
  const projectGallery = (Array.isArray(projects.images) ? (projects.images as unknown[]) : [])
    .map((item) => text(item))
    .filter(Boolean);
  ...
  const hasPartnersTemplate = hasTemplate("flooringPartnersSection") || hasTemplate("partnersSection");
  const partnersTemplate = hasTemplate("flooringPartnersSection") ? "flooringPartnersSection" : "partnersSection";
    ...
    <div className="flex flex-col bg-white text-[var(--cp-primary-500)]">
        ...
        >
          ...
          <div className="cp-container relative h-full px-4 md:px-8">
            <div className="absolute left-4 top-[247px] w-[345px] max-w-[calc(100%-32px)] md:left-8 md:top-auto md:w-auto md:max-w-[806px] md:bottom-8">
              ...
              >
                {text(hero.heading, "Flooring for Spokane Homes, Picked to Last")}
              </h1>
              <p
              ...
              >
                {text(
                  hero.subtext,
                  "Hardwood, luxury vinyl plank, tile, and laminate sourced from trusted suppliers. Stop by the Spokane showroom to compare wear ratings, textures, and colors alongside your cabinets and countertops.",
                )}
              </p>
              <div className="mt-6 md:mt-8">
                <Button
                  dataTinaField={tinaField(heroRecord, "ctaLabel")}
                  href={text(hero.ctaLink, "/contact-us")}
                  variant="primary"
                >
                  {text(hero.ctaLabel, "Request a Consultation")}
                </Button>
              </div>
            </div>
          </div>
      ...
      {hasTemplate("productsSection") ? (
        ...
        >
          ...
          >
            {text(materials.title, "Flooring Types")}
          </h2>
          ...
          <div className="mt-10 text-center md:mt-12">
            <Button className="!min-h-12 md:!min-h-14" href="/contact-us" variant="outline">
      ...
      {hasPartnersTemplate ? (
        <div style={{ order: getSectionOrder(partnersTemplate, 3) }}>
          <FlooringPartnersSection block={partnersRecord} />
        </div>
      ) : null}
        ...
        >
          ...
          <div className="cp-container relative h-full px-4 md:px-8">
            <div className="absolute left-4 top-[247px] w-[345px] max-w-[calc(100%-32px)] md:left-8 md:top-[225px] md:w-auto md:max-w-[806px]">
              ...
              >
                {text(showroomBanner.heading, "Feel the Floor Before You Buy It")}
              </h2>
              <p
              ...
              >
                {text(
                  ...
                  "Visit the Spokane showroom to walk on hardwood, vinyl, and tile side by side. Our team will help match the flooring to the cabinets and counters you're choosing.",
                )}
              </p>
      ...
      {hasTemplate("contactSection") ? (
        <div style={{ order: getSectionOrder("contactSection", 7, 1) }}>
